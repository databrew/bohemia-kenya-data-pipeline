...
# create the dataset for the extid explorer
  ...
  by_visit <- pfu_reason %>%
    ...
    dplyr::select(extid, hhid, pregnancy_status_V2,
                  ...
                  pregnancy_status_V8, pregnancy_status_V9, pregnancy_status_V10, pregnancy_status_reason_V2, 
                  ...
                  pregnancy_status_reason_V8, pregnancy_status_reason_V9, pregnancy_status_reason_V10, cluster) %>%
