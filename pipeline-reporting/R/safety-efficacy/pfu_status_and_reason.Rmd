...
# create the dataset for the extid explorer
  data_investigation <- data %>%
    ...
    select(visit, extid, pregnancy_status, pregnancy_status_reason, enrolment, sex_v0, sex_pregnancy, dob_v0, dob_pregnancy, todays_date_v0, todays_date_pregnancy)
  ...
  by_visit <- pfu_reason %>%
    ...
    dplyr::select(extid, hhid, pregnancy_status_V2,
                  ...
                  pregnancy_status_V6, pregnancy_status_reason_V2, 
                  pregnancy_status_reason_V3, pregnancy_status_reason_V4, 
                  pregnancy_status_reason_V5, 
                  pregnancy_status_reason_V6, cluster) %>%
...
```
Note: in V2 we identified extid '14024-02' to have been pregnant but not have taken drug, so they were removed from PFU.
