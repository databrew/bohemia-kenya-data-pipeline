...
In V5 `r v6_total_visited` children were visited. If the target for efficacy was `r num_v5_clean`, then this means that `r num_v5_clean - v6_total_visited` less children were visited than expected. See below:
...
After removing migrations, deaths, refusals, and eos, we enter V7 with a target of `r num_v6_clean`. See below:
  ...
  * `r v6_total_visited` (V5 submissions) + `r num_v6_not_visited` (extids not visited) - `r v6_removed_extids` (removed extids) = `r  sum(v6_total_visited + num_v6_not_visited - v6_removed_extids)`
