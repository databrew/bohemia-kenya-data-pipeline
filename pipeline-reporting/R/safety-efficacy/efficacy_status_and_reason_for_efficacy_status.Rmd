...
v3_clean <- v3 %>%
  ...
  bind_rows(v3_extid_not_visited) 
...
test <- semi_join(v5_extid_not_visited, v4_extid_not_visited, by='extid')
...
In preparation for V4, migrations, deaths, refusals, and eos children needed to be removed from the data as well as children who had not yet enrolled since V3 is the last opportunity for enrollment. `r v3_removed_extids` kids were removed going into V4 for the following reasons:
...
After removing migrations, deaths, refusals, and eos, we enter V4 with a target of `r num_v3_clean`. See below:
  ...
  * `r v3_total_visited` (V3 submissions) + `r num_v3_not_visited` (extids not visited) - `r v3_removed_extids` (removed extids) = `r  sum(v3_total_visited + num_v3_not_visited - v3_removed_extids)`
