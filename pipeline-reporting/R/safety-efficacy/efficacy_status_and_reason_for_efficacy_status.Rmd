...
## tracking efficacy statuses
  v1_status_pathway_data <- v1 %>%
    mutate(pathway = case_when(
      starting_efficacy_status == 'out' & efficacy_status == 'out' ~ 'out to out',
      starting_efficacy_status == 'eos' & efficacy_status == 'eos' ~ 'previously eos',
      starting_efficacy_status == 'refusal' & efficacy_status == 'refusal' ~ 'previously refusal',
      starting_efficacy_status == 'out' & efficacy_status == 'refusal' ~ 'out to refusal',
      starting_efficacy_status == 'out' & efficacy_status == 'in' ~ 'out to in',
      starting_efficacy_status == 'out' & efficacy_status == 'out' ~ 'out to out',
      starting_efficacy_status == 'out' & efficacy_status == 'eos' ~ 'out to eos',
      starting_efficacy_status == 'in' & efficacy_status == 'eos' ~ 'in to eos',
      starting_efficacy_status == 'in' & efficacy_status == 'refusal' ~ 'in to refusal',
      starting_efficacy_status == 'in' & efficacy_status == 'in' ~ 'in to in',
      starting_efficacy_status == 'in' & efficacy_status == 'completion' ~ 'in to completion',
      TRUE ~ 'other'
    ))
  ...
  v5_status_pathway <- v5_status_pathway_data %>%
    group_by(pathway) %>%
    summarize(count = n()) %>%
    add_row(pathway = 'total', count = sum(.$count))
  
    v6_status_pathway_data <- v6 %>%
    mutate(pathway = case_when(
      starting_efficacy_status == 'out' & efficacy_status == 'out' ~ 'out to out',
      starting_efficacy_status == 'eos' & efficacy_status == 'eos' ~ 'previously eos',
      starting_efficacy_status == 'refusal' & efficacy_status == 'refusal' ~ 'previously refusal',
  ...
  v6_status_pathway <- v6_status_pathway_data %>%
    group_by(pathway) %>%
    summarize(count = n()) %>%
    add_row(pathway = 'total', count = sum(.$count))
  
    v7_status_pathway_data <- v7 %>%
    mutate(pathway = case_when(
      starting_efficacy_status == 'out' & efficacy_status == 'out' ~ 'out to out',
      starting_efficacy_status == 'eos' & efficacy_status == 'eos' ~ 'previously eos',
      starting_efficacy_status == 'refusal' & efficacy_status == 'refusal' ~ 'previously refusal',
  ...
  v7_status_pathway <- v7_status_pathway_data %>%
    group_by(pathway) %>%
    summarize(count = n()) %>%
    add_row(pathway = 'total', count = sum(.$count))
...
status_pathway <- v1_status_pathway_data %>%
  ...
  merge(v5_status_pathway_data, by='extid') %>%
  select(extid, path_v1, path_v2, path_v3, path_v4, pathway) %>%
  rename(path_v5 = pathway) %>%
  merge(v6_status_pathway_data, by='extid') %>%
  select(extid, path_v1, path_v2, path_v3, path_v4, path_v5, pathway) %>%
  rename(path_v6 = pathway) %>%
  merge(v7_status_pathway_data, by='extid') %>%
  select(extid, path_v1, path_v2, path_v3, path_v4, path_v5, path_v6, pathway) %>%
  rename(path_v7 = pathway) %>%
...
#write.csv(status_pathway, file='V1.0 repeat efficacy status pathways.csv')
...
# present the rdt results for the different visits
  eff_results <- df %>%
    select(extid, cluster, pan_result, pf_result, visit, efficacy_status, assignment) %>%
...
enrolled_1 <- enrolled %>%
  ...
  enrolled_tested_v1_1 <- eff_results_v1_clean %>% 
    filter(extid %in% enrolled$extid,
           assignment ==1,
           visit == 'V1') %>% 
    distinct(extid) %>% 
  ...
  enrolled_tested_v2_1 <- eff_results_v2_clean %>% 
    filter(extid %in% enrolled$extid,
           assignment ==1,
           visit == 'V2') %>% 
    distinct(extid) %>% 
  ...
  enrolled_tested_v3_1 <- eff_results_v3_clean %>% 
    filter(extid %in% enrolled$extid,
           assignment ==1,
           visit == 'V3') %>% 
    distinct(extid) %>% 
  ...
  enrolled_tested_v4_1 <- eff_results_v4_clean %>% 
    filter(extid %in% enrolled$extid,
           assignment ==1,
           visit == 'V4') %>% 
    distinct(extid) %>% 
  ...
  enrolled_tested_v5_1 <- eff_results_v5_clean %>% 
    filter(extid %in% enrolled$extid,
           assignment ==1,
           visit == 'V5') %>% 
    distinct(extid) %>% 
  ...
  enrolled_tested_v6_1 <- eff_results_v6_clean %>% 
    filter(extid %in% enrolled$extid,
           assignment ==1,
           visit == 'V6') %>% 
    distinct(extid) %>% 
  ...
  enrolled_tested_v7_1 <- eff_results_v7_clean %>% 
    filter(extid %in% enrolled$extid,
           assignment ==1,
           visit == 'V7') %>% 
    distinct(extid) %>% 
...
flowchart_1 <- glue("
  digraph flowchart {{
    ...
    reasons [label = '{enrolled_tested_v1_1} tested subjects in V1\n{enrolled_tested_v2_1} tested subjects in V2\n{enrolled_tested_v3_1} tested subjects in V3\n{enrolled_tested_v4_1} tested subjects in V4\n{enrolled_tested_v5_1} tested subjects in V5\n{enrolled_tested_v6_1} tested subjects in V6\n{enrolled_tested_v7_1} tested subjects in V7'];
...
flowchart_2 <- glue("
  digraph flowchart {{
    ...
    reasons [label = '{enrolled_tested_v1_2} tested subjects in V1\n{enrolled_tested_v2_2} tested subjects in V2\n{enrolled_tested_v3_2} tested subjects in V3\n{enrolled_tested_v4_2} tested subjects in V4\n{enrolled_tested_v5_2} tested subjects in V5\n{enrolled_tested_v6_2} tested subjects in V6\n{enrolled_tested_v7_2} tested subjects in V7'];
