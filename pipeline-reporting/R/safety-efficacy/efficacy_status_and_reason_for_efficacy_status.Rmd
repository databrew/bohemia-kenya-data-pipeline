...
# present the rdt results for the different visits
  eff_results <- df %>%
    select(extid, cluster, pan_result, pf_result, visit, efficacy_status, assignment, desiccant_color, desiccant_color_2, rdt_control_window, rdt_control_window_b) %>%
...
# calculate invalid test per visit
  ...
  enrolled_invalid_v1_1 <- eff_results %>% 
    ...
    distinct(extid) %>% 
    nrow()
  # remember here that the number of treated and not took drug is only looking at in people so the others are not accounted for
...
flowchart_1 <- glue("
  digraph flowchart {{
    ...
    v1 [label = '{enrolled_tested_v1_1} visited in V1\nTreated in V1: {enrolled_valid_v1_1}\nDrug not taken in V1: {enrolled_invalid_v1_1}'];
    v2 [label = '{enrolled_tested_v2_1} visited in V2\nTreated in V2: {enrolled_valid_v2_1}\nDrug not taken in V2: {enrolled_invalid_v2_1}'];
    v3 [label = '{enrolled_tested_v3_1} visited in V3\nTreated in V3: {enrolled_valid_v3_1}\nDrug not taken in V3: {enrolled_invalid_v3_1}'];
    v4 [label = '{enrolled_tested_v4_1} visited in V4\nTreated in V4: {enrolled_valid_v4_1}\nDrug not taken in V4: {enrolled_invalid_v4_1}'];
    v5 [label = '{enrolled_tested_v5_1} visited in V5\nTreated in V5: {enrolled_valid_v5_1}\nDrug not taken in V5: {enrolled_invalid_v5_1}'];
    v6 [label = '{enrolled_tested_v6_1} visited in V6\nTreated in V6: {enrolled_valid_v6_1}\nDrug not taken in V6: {enrolled_invalid_v6_1}'];
    v7 [label = '{enrolled_tested_v7_1} visited in V7\nTreated in V7: {enrolled_valid_v7_1}\nDrug not taken in V7: {enrolled_invalid_v7_1}'];
...
flowchart_2 <- glue("
  digraph flowchart {{
    ...
    v1 [label = '{enrolled_tested_v1_2} visited in V1\nTreated in V1: {enrolled_valid_v1_2}\nDrug not taken in V1: {enrolled_invalid_v1_2}'];
    v2 [label = '{enrolled_tested_v2_2} visited in V2\nTreated in V2: {enrolled_valid_v2_2}\nDrug not taken in V2: {enrolled_invalid_v2_2}'];
    v3 [label = '{enrolled_tested_v3_2} visited in V3\nTreated in V3: {enrolled_valid_v3_2}\nDrug not taken in V3: {enrolled_invalid_v3_2}'];
    v4 [label = '{enrolled_tested_v4_2} visited in V4\nTreated in V4: {enrolled_valid_v4_2}\nDrug not taken in V4: {enrolled_invalid_v4_2}'];
    v5 [label = '{enrolled_tested_v5_2} visited in V5\nTreated in V5: {enrolled_valid_v5_2}\nDrug not taken in V5: {enrolled_invalid_v5_2}'];
    v6 [label = '{enrolled_tested_v6_2} visited in V6\nTreated in V6: {enrolled_valid_v6_2}\nDrug not taken in V6: {enrolled_invalid_v6_2}'];
    v7 [label = '{enrolled_tested_v7_2} visited in V7\nTreated in V7: {enrolled_valid_v7_2}\nDrug not taken in V7: {enrolled_invalid_v7_2}'];
