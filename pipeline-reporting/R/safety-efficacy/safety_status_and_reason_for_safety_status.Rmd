...
# not enrolled participants
  ...
  amount_not_enrolled <- length(unique(not_enrolled$extid)) - 1795
...
```{r trial_enrolled}
cat(amount_enrolled, 'participants enrolled in Safety')
...
cat(amount_not_enrolled, 'participants were not enrolled in Safety')
