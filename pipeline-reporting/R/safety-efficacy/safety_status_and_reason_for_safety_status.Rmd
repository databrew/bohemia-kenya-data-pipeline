...
So now there is a V2 target of `r num_hhid_v2_target` households.
...
* `r num_v1_in` in + `r num_v1_out_clean` out = `r num_v1_in + num_v1_out_clean` V2 Target
