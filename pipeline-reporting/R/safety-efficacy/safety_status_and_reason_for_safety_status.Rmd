...
non_enrolled_1 <- not_enrolled %>%
  ...
  not_enrol_ref_1 <- not_enrolled %>%
    filter(assignment == 1,
           reason_V1 != 'does not speak English or Swahili' | 
             reason_V2 != 'does not speak English or Swahili' | 
             reason_V3 != 'does not speak English or Swahili' | 
             reason_V4 != 'does not speak English or Swahili',
