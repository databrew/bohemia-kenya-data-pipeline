...
#### Individual Level
At the invidivual level, people can be visited throughout Safety who were previously added to the household in Demography or they can be added to a household in Safety V1, V2, or V3 through the Safety New Members Form. For the purposes of this document we will refer to safety new member people as __type new__ and people who joined a household in Demography as type __OG__.   
...
Now that we understand why the target is different, let's clean V1 by removing all migrations, deaths, and 100% refusal households: 
...
Above people who are migrated or died are considered migrated or died while people in 100% refusal households are households with all refusals. However, in reality a 100% refusal household is considered a household with people who all refused, migrated or died. Therefore, the above could be broken down in the following way:

* `r num_v1_out_mig` migrations (which are not a part of 100% refusal households),    
* `r num_v1_out_died` deaths (which are not a part of 100% refusal households), and    
* `r num_v1_ref_removed` people belonging to 100% refusal households.  
* Total of above = `r num_v1_out_mig + num_v1_out_died + num_v1_ref_removed` people  
...
Now that the data has been cleaned, we will calculate the V2 Target number. The V2 Target will reflect the number of people who can be visited in the next visit (out and in people) or continue in the study.
...
> Potentially adding the image from Safety Document here...
