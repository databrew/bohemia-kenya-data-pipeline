...
INPUT_KEY <- 
  list(
    craremotemonitoring = glue::glue('kwale_training/craremotemonitoring/craremotemonitoring.csv'),
    siteremotemonitoring = glue::glue('kwale_training/siteremotemonitoring/siteremotemonitoring.csv')
  )
