---
title: "Lab Monitoring Report"
description: |
  Lab Reporting used to track Issues for Monitoring
date: "`r Sys.time()`"
output:
  html_document:
    toc: yes
...
REPORTING_BUCKET_NAME <- 'bohemia-reporting-lab-monitoring'
...
siteremotemonitoring <- cloudbrewr::aws_s3_get_table(
  ...
  dplyr::filter(stringr::str_detect(report_id, 'LAB'))
```
...
[PLEASE CHECK THIS REPORT FOR ISSUE TRACKING](https://d27fg4iv55pk9u.cloudfront.net/monitoring-issues-ui/issue_ui.html)
...
## lab Site Monitoring Open Issues
...
## lab Site Monitoring Closed Issues
